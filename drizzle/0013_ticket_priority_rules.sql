...
VALUES
  ('priority-p1-major-outage', 'P1－全公司重大服務中斷', '全公司、全廠或主要據點的重大服務中斷。', '[]', '["全公司","全廠","主要據點","大量使用者受影響"]', '緊急', '網路連線', '網路維運組', 1, 1, 10, 1, CURRENT_TIMESTAMP, 'system', CURRENT_TIMESTAMP, 'system'),
  ...
  ('priority-p3-default-service', 'P3－一般服務異常', '一般使用者服務異常的預設分類。此規則不含關鍵字，僅供管理者參考。', '[]', '[]', '中', '其他', 'MIS 服務台', 0, 0, 900, 1, CURRENT_TIMESTAMP, 'system', CURRENT_TIMESTAMP, 'system'),
